...
//1 . Create a context (It's a component, so needs to be capital first letter)
// Use Context When:
// You're managing app-wide state (e.g. theme, user session, cart).
// You’re tired of "prop drilling" through deeply nested components.
// Multiple sibling components need access to the same data or function.
...
function Header() {
  // 3. Consuming context value, easier to destruct the context
